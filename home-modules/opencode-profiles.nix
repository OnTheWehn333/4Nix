{
  ...
  profileDefinitions = {
    ...
    openai = {
      sisyphus = "openai/gpt-5.3-codex";
      prometheus = "openai/gpt-5.3-codex";
      "frontend-ui-ux-engineer" = "openai/gpt-5.3-codex";
      librarian = "openai/gpt-5.2";
      explore = "openai/gpt-5.2";
      "document-writer" = "openai/gpt-5.2";
      "multimodal-looker" = "openai/gpt-5.2";
    };
  };
